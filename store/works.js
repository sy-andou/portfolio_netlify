export const state=()=>({
  workLists: [
    ...
    },
    {
            ...
            "detail": 'レストランの予約管理アプリケーションになります。検索・お気に入り登録・予約・レビュー投稿を行うことができます。また一般利用者以外の店舗代表者や管理者用の管理機能も作成しました。とくにこだわった点は、同一店舗かつ同一日時の既予約から残り予約可能人数を自動計算し、それ以上の人数は予約ができないようにしております。<br>サンプルアカウント<br>【管理者】email:sample@administrators.com, password:password<br>【店舗代表者】email:sample@representatives.com, password:password<br>【一般ユーザ】email:userA@users.com, password:password',
